...
class TestNode(TestCase):
    ...
    def test_block_is_new_tip(self, _, m_call_silent, m_check_output):
        ...
        received = node.block_is_new_tip('hash')
    ...
    @patch('bash.call_silent')
    @patch('dockercmd.exec_cmd')
    def test_block_is_new_tip_never_received(self, _, m_call_silent, m_check_output):
        node = BitcoinNode('node-0', '1.1.1.1')
