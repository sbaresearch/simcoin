...
ticks_stats$values <- c(
  ...
  round(min(tick_infos$tick_duration), 3),
  round(max(tick_infos$tick_duration), 3)
)
...
*The `r table(blocks$total_received)['0']` blocks which were never received by another node are not included in this section*
...
*The `r table(txs$total_accepted)['0']` transaction which never reached another node are not included in this section*
