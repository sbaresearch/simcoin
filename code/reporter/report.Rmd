...
kable(block_dist_summary, col.names = c('Share [%]', 'Blocks', 'Blocks share [%]'), digits = 2, caption = 'Accepted block distribution summary', format = 'latex') %>%
  kable_styling(latex_options = c('HOLD_position'))
```

```{r block_distribution, eval=nlevels(nodes$group)>0, fig.cap='Accepted block distribution', fig.pos='H'}
