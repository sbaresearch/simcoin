...
plot(memory$timestamp - sim_start, memory$usage, xlab = 'Time [s]', ylab='Memory usage [%]', type = 'b')
```
...
plot(cpu_time_delta$timestamp  - sim_start, cpu_time_delta$usage, xlab = 'Time [s]', ylab='CPU usage [%]', type = 'b')
```
