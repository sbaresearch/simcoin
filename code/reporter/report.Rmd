...
```{r block_exces_distribution, error=TRUE, fig.height=6}
...
### Exception error message
```{r tx_exces_distribution, error=TRUE, fig.height=6}
...
### Exception error message
```{r rpc_exces_distribution, error=TRUE, fig.height=6}
