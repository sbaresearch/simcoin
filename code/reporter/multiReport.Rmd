...
par(mfrow=c(1,2))
kable(block_size_stats,  align = c('l'), col.names = c('_', 'value'), format = 'latex')
...
kable(block_propagation_stats,  align = c('l'), col.names = c('', 'value'), format = 'latex')
```
...
kable(txs_median_propagation,  align = c('l'), col.names = c('', 'value'), format = 'latex')
```
...
kable(txs_per_block_stats,  align = c('l'), col.names = c('', 'value'), format = 'latex')
```
