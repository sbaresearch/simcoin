...
densityplot(~propagation_duration, data=blocks_received, groups = tag, auto.key = list(space = "right"), ref = TRUE, xlab = 'Duration [s]')
```
...
densityplot(~propagation_duration, data=txs_received, groups = tag, auto.key = list(space = "right"), ref = TRUE, xlab = 'Duration [s]')
```
