...
xyplot(cpu_time_diff$usage ~ cpu_time_diff$elapsed, groups = cpu_time_diff$tag, xlab = 'Time [s]', ylab = 'CPU usage [%]', t = 'l' )
```
...
barchart(as.matrix(step_diff), stack = TRUE, ref = FALSE, xlab = 'Time [s]', auto.key = list(space='top',text=colnames(step_diff)))
```
