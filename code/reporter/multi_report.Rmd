...
kable(block_dist_summary, col.names = c('', 'Group', 'Share [%]', 'Blocks', 'Blocks share [%]'), digits = 2, caption = 'Block distribution summary', format = 'latex') %>%
  kable_styling(latex_options = c('scale_down', 'HOLD_position')) %>%
  collapse_rows(columns = 1)
```

```{r block_distribution, fig.cap='Block distribution', fig.pos='H'}
...
block_dist           <- block_dist[ , !(names(block_dist) %in% c('tag'))]
